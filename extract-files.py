...
blob_fixups: blob_fixups_user_type = {
    ...
    'vendor/lib64/hw/mt6878/vendor.mediatek.hardware.pq@2.15-impl.so': blob_fixup()
        .add_needed('android.hardware.sensors@1.0-convert-shared.so')
    ...
    ('vendor/lib64/mt6878/libcam.hal3a.v3.so', 'vendor/lib64/hw/hwcomposer.mtk_common.so'): blob_fixup()
        .add_needed('libprocessgroup_shim.so'),
    ('vendor/lib/mt6878/libneuralnetworks_sl_driver_mtk_prebuilt.so', 'vendor/lib64/mt6878/libneuralnetworks_sl_driver_mtk_prebuilt.so', 
